...
public class TrayIconService : IDisposable
{
    ...
    private readonly Action? _openLiveCaptions;
    private Window? _settingsWindow;

    /// <summary>Reserved for future tray UX that reacts to suppression state. Currently unused.</summary>
    ...
    public TrayIconService(
        ...
        Action? openLiveCaptions = null)
    {
        _loggingService = loggingService;
        _settingsService = settingsService;
        _reloadHotkeys = reloadHotkeys;
        _openChat = openChat;
        _openLiveCaptions = openLiveCaptions;
    ...
    private void CreateContextMenu()
    {
        ...
        var captionsItem = new ToolStripMenuItem("Live Captions", null, (_, _) => _openLiveCaptions?.Invoke());
        ...
        contextMenu.Items.Add(captionsItem);
