...
public partial class HotkeySettingsWindow : Window
{
    ...
    [
        ...
        ("CleanupWordBank",            "Clean Up Word Bank",           "🧹"),
        ("ResetAllWordBank",           "Reset All Word Bank",          "🗑"),
        ("FixClipboardCapitalization", "Fix Clipboard Capitalization", "✏"),
        ("FixGrammar",                 "Fix Grammar / Spelling",     "🔍"),
        ("CompleteSentence",           "Complete Current Sentence",    "✨"),
        ("OpenModeMenu",               "Open Quick Menu", "☰"),
        ("OpenLiveCaptions",           "Open Live Captions", "🗣"),
    ...
    private static readonly Dictionary<string, string> DefaultGestures = new()
    {
        ...
        ["CleanupWordBank"]            = "Ctrl+Shift+X",
        ["ResetAllWordBank"]           = "Ctrl+Shift+Delete",
        ["FixClipboardCapitalization"] = "Ctrl+Shift+C",
        ["FixGrammar"]                 = "Ctrl+Shift+G",
        ["CompleteSentence"]           = "Ctrl+Shift+S",
        ["OpenModeMenu"]               = "Ctrl+Shift+F3",
        ["OpenLiveCaptions"]           = "Ctrl+Shift+L",
